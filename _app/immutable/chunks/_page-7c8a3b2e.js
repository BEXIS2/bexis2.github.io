var ht=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function ut(R){return R&&R.__esModule&&Object.prototype.hasOwnProperty.call(R,"default")?R.default:R}var Y={},pt={get exports(){return Y},set exports(R){Y=R}};(function(R,le){(function(F,N){N(le)})(ht,function(F){var N=function(){function D(r,S){function e(){this.constructor=r}e.prototype=S.prototype,r.prototype=new e}function C(r,S,e,b){this.message=r,this.expected=S,this.found=e,this.location=b,this.name="SyntaxError",typeof Error.captureStackTrace=="function"&&Error.captureStackTrace(this,C)}D(C,Error),C.buildMessage=function(r,S){var e={literal:function(m){return'"'+A(m.text)+'"'},class:function(m){var y="",w;for(w=0;w<m.parts.length;w++)y+=m.parts[w]instanceof Array?B(m.parts[w][0])+"-"+B(m.parts[w][1]):B(m.parts[w]);return"["+(m.inverted?"^":"")+y+"]"},any:function(m){return"any character"},end:function(m){return"end of input"},other:function(m){return m.description}};function b(m){return m.charCodeAt(0).toString(16).toUpperCase()}function A(m){return m.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\0/g,"\\0").replace(/\t/g,"\\t").replace(/\n/g,"\\n").replace(/\r/g,"\\r").replace(/[\x00-\x0F]/g,function(y){return"\\x0"+b(y)}).replace(/[\x10-\x1F\x7F-\x9F]/g,function(y){return"\\x"+b(y)})}function B(m){return m.replace(/\\/g,"\\\\").replace(/\]/g,"\\]").replace(/\^/g,"\\^").replace(/-/g,"\\-").replace(/\0/g,"\\0").replace(/\t/g,"\\t").replace(/\n/g,"\\n").replace(/\r/g,"\\r").replace(/[\x00-\x0F]/g,function(y){return"\\x0"+b(y)}).replace(/[\x10-\x1F\x7F-\x9F]/g,function(y){return"\\x"+b(y)})}function O(m){return e[m.type](m)}function te(m){var y=new Array(m.length),w,z;for(w=0;w<m.length;w++)y[w]=O(m[w]);if(y.sort(),y.length>0){for(w=1,z=1;w<y.length;w++)y[w-1]!==y[w]&&(y[z]=y[w],z++);y.length=z}switch(y.length){case 1:return y[0];case 2:return y[0]+" or "+y[1];default:return y.slice(0,-1).join(", ")+", or "+y[y.length-1]}}function ne(m){return m?'"'+A(m)+'"':"end of input"}return"Expected "+te(r)+" but "+ne(S)+" found."};function ae(r,S){S=S!==void 0?S:{};var e={},b={START:Xe},A=Xe,B=function(t){return t.reduce((i,s)=>{let n=i[i.length-1];return n&&n.itemtype==="comment"&&s.itemtype==="comment"?n.comment+=s.comment:i.push(s),i},[])},O=E("preamble, entry, string, or comment"),te=function(t){return{itemtype:"preamble",...t}},ne=function(t){return{itemtype:"string",...t}},m=function(t){return{itemtype:"entry",...t}},y=function(t){return{itemtype:"comment",comment:t}},w=E("preamble"),z="@preamble",Ye=v("@preamble",!0),K="(",X=v("(",!1),W=")",q=v(")",!1),ea=function(t){return{enclosed:"parentheses",...t}},G="{",M=v("{",!1),k="}",j=v("}",!1),aa=function(t){return{enclosed:"braces",...t}},ta=function(t){return{enclosed:"parentheses",value:t,datatype:"unenclosed",raw:t}},na=function(t){return{enclosed:"braces",value:t,datatype:"unenclosed",raw:t}},ia=function(t){return t},sa=E("string"),ra="@string",oa=v("@string",!0),ie=function(t){return t},la=E("comment"),de=/^[^@]/,fe=T(["@"],!0,!1),he="@",ue=v("@",!1),pe="comment",me=v("comment",!0),ge=/^[^\n\r]/,ye=T([`
